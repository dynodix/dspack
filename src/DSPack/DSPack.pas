...
uses
  ...
  DirectDraw, DXSUtils, ComCtrls, MMSystem, Math, Consts, ExtCtrls,
  MultiMon, Dialogs, Registry, SyncObjs, Direct3D9, WMF9, AppEvnts;
...
// *****************************************************************************
  ...
  var hr: HRESULT;
      ...
      //lEventCode: Longint; out lParam1, lParam2: LONG_PTR;;
  begin
...
//    FFullScreenControl.OnCloseQuery := FullScreenCloseQuery;
    ...
    FAppEvents.OnIdle := MyIdleHandler;
//    Application.OnIdle := MyIdleHandler; //SZ - AV
  end;
...
//    Application.OnIdle := nil; //SZ - fixes AV // replaced by AppEvnts
  ...
  begin
    Done := True;
    if (FIdleCursor = 0) or (csDesigning in ComponentState) or (csDestroying in ComponentState) then exit;
